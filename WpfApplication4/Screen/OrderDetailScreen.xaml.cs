    ...
    public partial class OrderDetailScreen : Window
    {
      ...
      private bool isEdited;
        ...
        private void LoadingMap()
        {
            ...
            int divideCountIndex = txtAddrExtra.Text.Trim().IndexOf("-");
            int divideSpaceIndex = txtAddrExtra.Text.Trim().IndexOf(" ");
            if (divideCountIndex > 0)
            {
                ...
                {
                    sb.Append(txtAddrExtra.Text.Trim());
                }
        ...
        private void btnPrint_Click(object sender, RoutedEventArgs e)
        {
            ...
            PrintManager.PrintOrderInfo(OrderData, chcIsMotel.IsChecked);
